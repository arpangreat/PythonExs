...
class nor:
    def normalCalc(self):
        ...
        print(
            "Enter 1 for sum , 2 for substraction , 3 for multiply , 4 for dividation"
        )
...
v = int(
    input(
        "Enter 1 for normal calculator and 2 for 2/2 Matrix calculator and CTRL-C for Human Calculator: "
    )
)
